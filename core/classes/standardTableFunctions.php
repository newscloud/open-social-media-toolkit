<?php
	/*
	 * These are the standard 'base class' functions for the table classes.
	 * Table classes are not implemented with a common parent because it would be messy,
	 * This code *would* be include(..)'ed inside each class, except PHP devs decided
	 * not to implemented include behavior in such a useful way. Please complain to them.
	 * 
	 */
	
	///////////////////////////////////////////////////////////////////////////////////////////////////////
	// reference versions of standard table functions -- refer here if in doubt!

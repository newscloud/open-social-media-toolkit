...
<form method="post" action="<? echo url_for('street_team', 'award_prize'); ?>&mail">
...
function sendEmail($mailObj)
{
	...
	{
		echo 'Failed to send mail! Back to <a href="index.php?p=console&ctrl=street_team&action=leaders">Leaders</a>.'; 

<?php
	...
	define ("SITE_SPONSOR",'Grist');
	define ("SITE_TOPIC",'Climate');
	define ("CACHE_PREFIX",'hd');
	define ("TWITTER_USER","hotdishnews");
	define ("USE_ADVERTISING",FALSE);
	define ("ADS_LARGEBANNER",FALSE);
	define ("USE_RECAPTCHA",FALSE);
	define ("NAV_INCL_BLOGS",false);
	DEFINE ("AMAZON_ASSOCIATE_ID","hotdish-20");
	...
	define ("PATH_SITE_IMAGES", SRC_ROOT.'/sites/climate/facebook/images/');	
	define ("PATH_TEMPLATES",SRC_ROOT.'/sites/climate/facebook/templates');
	define ("PATH_STYLES",PATH_ROOT.'/facebook/styles'); // or, move to /smt/sites/climate/facebook/styles directory for site-specific approach
	define ("PATH_FACEBOOK_STYLES",SRC_ROOT.'/facebook/styles'); 	/*this has to have a shared name with constants.php*/
	define ("PATH_SCRIPTS",PATH_ROOT.'/facebook/scripts');
	// paths for admin uploads - djm
	define('PATH_UPLOAD_IMAGES', SRC_ROOT.'/sites/climate/facebook/uploads/images/');	
	// paths for user uploads - djm
	define('PATH_UPLOAD_SUBMISSIONS', SRC_ROOT.'/sites/climate/facebook/uploads/submissions/');
	...
	define("PATH_CRONLOG",'/var/log/smtCron.log'); // to get rid of this, point PATH_LOGS at /var/log ?
	define("PATH_SYNCLOGFILE",'/var/log/smtSync.log');

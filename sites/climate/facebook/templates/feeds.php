<?php
	...
	$defaultWelcomeMessage='We can do more, and have more fun doing it!<br>Help spread the word, drive the discussion on hot topics, and earn earth-happy prizes along the way.<br><br>Go to the <a href=\"{*url*}\">{*appName*}</a> application.';
	...
	$feeds['signup']=array(
							//one liners				
							'oneLine' => array( 
											'{*actor*} joined the Action Team with the '.$appLink.' application.'
											), 
							//short stories
							'shortStory' => array( 
												array (	'template_title' => '{*actor*} joined the Action Team with the '.$appLink.' application.',
														'template_body' => $defaultWelcomeMessage
													  )
												), 						
							//full story
							'fullStory' => array(	
												'template_title' => '{*actor*} joined the Action Team with the '.$appLink.' application.',
												'template_body' => $defaultWelcomeMessage
												)
							);
	...
	*/
	...
	$feeds['wonPrize']=array(
							//one liners				
							'oneLine' => array( 
											'{*actor*} won the prize <a href="{*storyLink*}">{*title*}</a> through the '.$appLink.' application.', 
											'{*actor*} won a prize with the '.$appLink.' application.'
											), 
							//short stories
							'shortStory' => array( 
												array (	'template_title' => '{*actor*} won the prize <a href="{*storyLink*}">{*title*}</a> through the '.$appLink.' application.',
														'template_body' => '{*story*}'
													  ),
												array (	'template_title' => '{*actor*} won a prize through the '.$appLink.' application.',
														'template_body' => '{*story*}'
													  )
												), 						
							//full story
							'fullStory' => array(	
												'template_title' => '{*actor*} won a prize through the '.$appLink.' application.',
												'template_body' => '{*story*}'.'<br><br>'.$defaultWelcomeMessage
												)
							);
	
	//when user redeems a prize			
	/* REDEEM: $feeds['redeemed']=array(
							//one liners				
							'oneLine' => array( 

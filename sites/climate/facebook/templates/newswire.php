...
'<span class="btn_right"><a href="{url}" onclick="log(\'readWire\',{id});" target="_cts">Read story</a></span>';
	...
	$this->addTemplate('wideTip','<div id="wideTipPanel" class="panel_1">
		...
		<div class="wideTipLeft">
            <p>The news in Hot Dish is driven by the editors at Grist.org and especially by YOU, the community. When you find environmental news of note, post it here, and help heat up the conversation around climate.</p>

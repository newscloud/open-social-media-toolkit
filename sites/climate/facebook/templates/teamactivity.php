...
//	$this->addTemplate('profileChallengeList','<ul id="challengeList">{items}</ul>'); 
	...
	$this->addTemplate('cbdPromo','Welcome to Hot Dish! As a thank you, we\'d like to offer you these <a href="'.URL_CANVAS.'?p=cbd">free ringtones of endangered species</a> courtesy of the Center for Biological Diversity.');

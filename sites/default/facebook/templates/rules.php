...
$static='<br /><h1>'.SITE_TITLE.' '.SITE_TEAM_TITLE.' Rules Summary</h1><h5>While not official, the following summary gives you a basic intro:</h5>';
    $static.='<p>Be sure to read the complete list of <a href="?p=tos" onclick="switchPage(\'static\',\'tos\');return false;">official rules for the '.SITE_TITLE.' '.SITE_TEAM_TITLE.'</a> before you sign up.</p>';
...
//          '<li>The Daily Action Team is scheduled to run from March 25, 2009 to May 12, 2009.</li>' .
          '<li>Like on Facebook, much of what you post, share, or say on '.SITE_TITLE.' application will appear on '.SITE_TITLE.', so don\'t share something you don\'t want people to see.</li>' .
          '<li>Info from '.SITE_TITLE.' will be shared with NewsCloud. Stories and comments you post will appear on the NewsCloud.com website.</li>' .
/*          '<li>The '.SITE_TEAM_TITLE.' is part of a voluntary research study conducted by University of Minnesota researchers. Participation is optional, and before you decide whether to participate, please read the <a href="'.URL_CANVAS.'?p=consent" target="_blank" onclick="switchPage(\'static\',\'consent\');return false;">consent form</a>.</li>' .*/
          '<li>Earn points by participating '.SITE_TITLE.' site. Always stay safe -- you\'re the only one responsible for your actions.</li>' .
...
//          '<li>Redemption of some rewards may require that you (or your parents, if you\'re a minor) sign an additional consent form.</li>' .
 //         '<li>Periodically, we\'ll offer reward(s) to the eligible members with the highest point totals in their category.</li>' .
    ...
    $category='rules';
    $static = $dynTemp->useDBTemplate('Rules',$static,'',false, $category);

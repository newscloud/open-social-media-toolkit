...
class accountTemplate
{
	...
	function fetchResearchFields($fdata)
	{
		if (ENABLE_RESEARCH_STUDY)
		{
			if ($fdata->showResearchImportance  OR isset($_GET['force'])) {
				...
				$importance=array(0=>'How interested are you in University of Minnesota community issues?',1=>'Extremely uninterested',2=>'Mostly uninterested',3=>'Somewhat uninterested',4=>'Neither interested nor uninterested',5=>'Somewhat interested',6=>'Mostly interested',7=>'Extremely interested');
	...
	function validateFormData($fdata)
	{
		...
		{
			$fdata->alert .= 'Please tell us your level of interest in University of Minnesota issues.<br />';
			$fdata->result = false;			
		}
